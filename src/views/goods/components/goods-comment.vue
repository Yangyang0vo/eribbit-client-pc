  ...
  <div class="goods-comment">
    <div class="head" v-if="commentInfo">
      ...
      <div class="tags">
        ...
        <div class="dd">
          <a href="javascript:;" :class="{ active: currentTagIndex === i }" v-for="(item, i) in commentInfo.tags" :key="item.title" @click="changeTag(i)">{{ item.title }}（{{ item.tagCount }}）</a>
        </div>
      </div>
    </div>
    ...
    <!-- 页码 -->
    <XtxPagination v-if="total" @current-change="changePagerFn" :total="total" :page-size="reqParams.pageSize" :currentPage="reqParams.page" />
  </div>
</template>
<script>
...
export default {
  ...
  setup() {
    ...
    return { total, changePagerFn, commentInfo, currentTagIndex, changeTag, reqParams, commentList, changeSort, formatSpecs, formatNickName }
  }
}
</script>
